...
// Copyright (c) 2013 The BountyCoin developers
...
uint256 hashGenesisBlock("0x000003037512bae62aff410414825f9807989ac44f1d77bd70048649c6502f48");
static const unsigned int timeGenesisBlock = 1481334237;
...
static const int64 nTargetTimespan = 60 * 60 * 24 * 30 * 6; // readjust difficulty once per hour
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "BountyCoin create";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xe6a62744f484a46b997e014322b8698ac85fa82c33cf56cd91884e5c9bff86fd"));
...
unsigned char pchMessageStart[4] = { 0x6, 0xf2, 0xd3, 0xf1 };
...
{
    printf("BountyCoinMiner started\n");
...
//            unsigned int nNonceFound;
    ...
    {
        printf("BountyCoinMiner terminated\n");
        throw;
    }
}
