    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a BountyCoin address (e.g. Qi1NooNjQySQLDJ643HWfZZ7UN2EmLEvix)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a BountyCoin address (e.g. Qi1NooNjQySQLDJ643HWfZZ7UN2EmLEvix)"));
