...
const QString BITCOIN_IPC_PREFIX("BountyCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click BountyCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start BountyCoin: click-to-pay handler");
    else
...
{
    // clicking on BountyCoin: URLs creates FileOpen events on the Mac:
